...
function resolveAsyncComponent (
  ...
  if (isTrue(factory.loadingMsgFull) && isDef(factory.loadingComp)) {
  ...
  if (isDef(factory.contexts)) {
    ...
    if (isObject(res)) {
      if (typeof res.then === 'function') {
        ...
        if (isDef(res.loadingMsgFull)) {
          factory.loadingComp = ensureCtor(res.loadingMsgFull, baseCtor);
          if (res.delay === 0) {
            factory.loadingMsgFull = true;
          } else {
            setTimeout(function () {
